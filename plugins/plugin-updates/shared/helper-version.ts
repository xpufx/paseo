// Declared paseo-plugin-helper expectation for plugin-updates.
//
...
// aliases into ../../packages/paseo-plugin-helper/src. A locally-loaded plugin-updates
...
export const HELPER_REVISION = "sha256:dd9bdb1ca07c";
